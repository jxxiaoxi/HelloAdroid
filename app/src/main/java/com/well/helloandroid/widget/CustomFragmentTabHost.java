package com.well.helloandroid.widget;
/*
...
/**
 * 修改FragmentTabHost源码将切换Fragment的方式detach和attach改为hide和show。
 * 解决java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState 异常，
 * fragment提交使用commitAllowingStateLoss()而不是使用commit();
